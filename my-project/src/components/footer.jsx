...
function Footer() {
    ...
    const toggleVisibility = () => {
      // Show footer when page is scrolled 300px or more
   ...
   const footerClasses = `bg-gray-900 text-white mt-20 fixed bottom-0 w-full transition-transform duration-300 ease-in-out ${
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">123 Street Name</li>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              />
              <button className="bg-blue-500 px-4 py-2 rounded-md hover:bg-blue-600 transition-colors">
                Send
              </button>
            </div>
          </div>
